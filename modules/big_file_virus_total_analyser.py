...
class BigFileVirusTotalAnalyser(BaseVirusTotalAnalyser):
    ...
    def analyse(self):
        ...
        with open(self.data, 'rb') as file:
            ...
            result_url = response_url = requests.post(response_upload_url.json()["data"], headers=self.headers, files=files)

            if result_url.status_code == 409:
...
file = BigFileVirusTotalAnalyser(os.getenv('API_KEY'), '/files/upload_url',
                                 '/home/ripher12/BackupPDFProtocolsScanFiles.exe')
