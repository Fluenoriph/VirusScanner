...
class ProgramProcessHandler:
    ...
    def __init__(self, input_data):
        # --------------------- target not file ---------------------
        if input_data[1] is not TARGET_FLAG[3]:



            if input_data[2] is VARIANT_FLAG[0]:
                # --------------------- object ---------------------
                ...
                if validator.validate(input_data[3]):
                    ...
                    print("Error argument") # BAD ARGUMENT !
            elif input_data[2] is VARIANT_FLAG[1]:
                pass # log variant
            else:
                pass # dir variant
        ...
        # --------------------- target is file ---------------------
            ...
            if file_size_selector.select(input_data[3]):
                ...
                if analyser.analyse():   # duplicating !!
                    ...
                    print("Result is NOT OK !")
                print(analyser.result_data)  # print out formatting !!!
